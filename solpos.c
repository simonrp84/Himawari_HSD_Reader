/*
Note: This code was downloaded from NREL.
The original can be found here: http://rredc.nrel.gov/solar/codesandalgorithms/solpos/
do not redistribute this code without a link and accreditation to the above.
*/
